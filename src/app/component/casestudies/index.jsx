...
const SelectSection = () => {
  return (
    <div className="flex flex-col items-center px-[10%] mt-[3%]">
      <h1 className="text-2xl text-[#525560] font-semibold">
        Choose a case study to explore
      </h1>
      <p className="text-center text-base font-medium text-[#525560] leading-normal max-w-[70%]">
